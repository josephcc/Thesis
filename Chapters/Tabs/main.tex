...
%Integrating the two approaches, we find that tabs serve a wider variety of diverse purposes than many users initially think they do, from finding or reminding to managing aspirations and expectations, but often do not serve them particularly well. The ways people instantiate and manage tabs may lead to a variety of common problems ranging from tab overload to obsolete tabs and involve psychological effects such as \emph{tab pressure}, frustration, and even \emph{shame}. Further, the underlying structures the web information users have on hand are often not supported by web browsers, such as task or topic hierarchies, levels of importance or relevance, different statuses (e.g., to-read or to-do), and different re-visitation patterns (e.g., frequently visited reference or pre-emptively opened shared documents). 
...
%More fundamentally, the internet itself has also gone through dramatic changes. Online information seeking has evolved from navigating to different websites with web directories for simple fact finding tasks\cite{dmoz}, to searching through dozens or even hundreds of webpages and online forums to support complex sensemaking and exploratory tasks \cite{pirolli1999information,marchionini2006exploratory}.
...
%Realizing such a drastic change in browser design and internet usage patterns, we decided to take an in-depth look at modern tabbed browsing -- across a variety of browsers and users. 
...
\subsection{Pressure to Close Tabs}
